...
console.log(baz4);// "aaa"  把aaa赋值给变量baz4
...
console.log(p);//报错 not defined 因为没有变量p var{p：...}中的p只是一个key值 并不是一个变量
...
var { loc: { start: { line }} } = node;//只有line是变量，loc和start都是模式key，不会被赋值。
console.log(line); // 1
